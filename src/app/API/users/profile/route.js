...
// Simplified GET handler to fetch user profile
export async function GET(req) {
  console.log("GET /API/users/profile route handler called");
...
export async function PUT(req) {
  console.log("PUT /API/users/profile route handler called");
  try {
